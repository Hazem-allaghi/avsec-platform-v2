-- ============================================================
-- Seed Part 1 — core reference data (NO dependency on auth.users)
-- Safe to run immediately after 0001_init.sql.
-- ============================================================
...
values ('AAW-MAN-2021-R01', 'AAW', 'AAWSM Rev 01', 'AAW_Security_Manual_final_2021_2_.pdf', true, '2021-10-01')
on conflict (manual_version_id) do nothing;

-- ---------- Checklist templates ----------
insert into checklist_templates (template_id, airline_id, manual_version_id, code, name, applies_to_stage, aircraft_type_filter, items_json, min_signatures)
values
('tpl-cl01', 'AAW', 'AAW-MAN-2021-R01', 'CL-01', 'Aircraft Security Search', 'AIRCRAFT_SECURITY_CHECK', null,
 '[{"code":"flight_deck","label":"Flight Deck","role_required":"FLIGHT_CREW"},
   ...
   {"code":"inlets_outlets","label":"Inlets/Outlets/Fuel/Water/APU","role_required":"GROUND_ENGINEER"}]'::jsonb, 3),
...
('tpl-cl02', 'AAW', 'AAW-MAN-2021-R01', 'CL-02', 'Baggage Reconciliation', 'BAGGAGE_RECONCILIATION', null,
 '[{"code":"count_match","label":"Registered bags = reconciled bags"},
   ...
   {"code":"crew_bags_matched","label":"Crew baggage matched & screened"}]'::jsonb, 1),
...
('tpl-cl03', 'AAW', 'AAW-MAN-2021-R01', 'CL-03', 'Catering Security', 'CATERING_SECURITY', null,
 '[{"code":"seal_match","label":"Truck seal number matches record"},
   ...
   {"code":"receiver_signoff","label":"Onboard receiver sign-off"}]'::jsonb, 1),
...
('tpl-cl04', 'AAW', 'AAW-MAN-2021-R01', 'CL-04', 'Cargo/Mail Acceptance', 'CARGO_MAIL_SECURITY', null,
 '[{"code":"consignor_status","label":"Consignor status documented"},
   ...
   {"code":"no_tamper_signs","label":"No visible tamper signs"}]'::jsonb, 1),
...
('tpl-cl05', 'AAW', 'AAW-MAN-2021-R01', 'CL-05', 'Aircraft Seal Verification', 'SEAL_VERIFICATION', null,
 '[{"code":"seal_numbers_match","label":"All seal numbers match issued record"},
   {"code":"no_missing_broken","label":"No missing or broken seal"}]'::jsonb, 1),
...
('tpl-cl06', 'AAW', 'AAW-MAN-2021-R01', 'CL-06', 'Security Declaration Pre-check', 'SECURITY_DECLARATION', null,
 '[{"code":"all_stages_passed","label":"CL-01..CL-05 all PASSED"},
   ...
   {"code":"officer_authorized","label":"Signing officer authorized & certified"}]'::jsonb, 1)
on conflict (template_id) do nothing;

-- ---------- Security rules (BR-01..BR-10) ----------
...
('BR-01', 'AAW-MAN-2021-R01', 'Aircraft security check must be PASSED', 'STAGE_MUST_BE_PASSED', '{"stage_code":"AIRCRAFT_SECURITY_CHECK"}'::jsonb, false, null),
('BR-02', 'AAW-MAN-2021-R01', 'No baggage/passenger mismatch allowed', 'BAGGAGE_MISMATCH_ZERO', null, false, null),
('BR-03', 'AAW-MAN-2021-R01', 'No open MAJOR/CRITICAL incidents', 'NO_OPEN_MAJOR_INCIDENTS', null, true, 'CSO'),
('BR-04', 'AAW-MAN-2021-R01', 'Broken catering seal requires manual inspection', 'CATERING_SEAL_CHECK', null, false, null),
('BR-05', 'AAW-MAN-2021-R01', 'Unknown cargo must be screened before acceptance', 'CARGO_UNKNOWN_SCREENED', null, false, null),
('BR-06', 'AAW-MAN-2021-R01', 'No broken/missing aircraft seal unresolved', 'AIRCRAFT_SEAL_CHECK', null, true, 'SUPERVISOR,SUPERINTENDENT,CSO'),
('BR-07', 'AAW-MAN-2021-R01', 'Declaring officer certification must be valid', 'OFFICER_CERT_VALID', null, false, null),
('BR-08', 'AAW-MAN-2021-R01', 'Declaring officer role must be authorized', 'OFFICER_ROLE_AUTHORIZED', '{"allowed_roles":["SECURITY_OFFICER","SUPERVISOR","SUPERINTENDENT","CSO"]}'::jsonb, false, null),
('BR-09', 'AAW-MAN-2021-R01', 'No open emergency event linked to flight', 'NO_OPEN_EMERGENCY', null, false, null),
('BR-10', 'AAW-MAN-2021-R01', 'Random screening percentage meets threat-level threshold', 'SCREENING_PCT_THRESHOLD', '{"required_pct":{"GREEN":10,"AMBER":20,"RED":50}}'::jsonb, false, null)
on conflict (rule_id) do nothing;

-- ---------- Prohibited items (category-level only — see R-016, open decision) ----------
